USE codeup_test_db;
TRUNCATE albums; -- added for the second part of the exercise
INSERT INTO albums ( artist, name, release_date, sales, genre)
  VALUES ('Michael Jackson','Thriller',1982, 47.3,'Pop, Rock, R&B'),
    ('AC/DC', 'Back in Black', 1980, 26.1, 'Hard rock'),
    ('Pink Floyd', 'The Dark Side of the Moon', 1980, 24.2, 'Progressive rock'),
    ...
    ('Various artists', 'Grease: The Original Soundtrack from the Motion Picture', 1978,
    14.4, 'Soundtrack'),
